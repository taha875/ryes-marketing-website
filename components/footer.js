        ...
        <div className="w-full  border-r border-gray-800  mr-24 px-12 py-16">
          <div className="flex items-center w-full">
            <h2 className="text-4xl leading-10 text-white font-medium flex flex-col">
              Are you ready? <span className="text-gray-600">because we are</span>
            </h2>

            <div className="ml-[260px]">
              <p className="text-xl font-medium leading-5 text-white">San Diego</p>
            ...
            <div className="ml-[68px]">
              <p className="text-xl font-medium leading-5 text-white">Islamabad</p>
              <p className="w-80 text-lg Sansmedium leading-7 text-gray-400 mt-5">
                Suite 301-305, Ground Floor, NSTP,
                <br />
                NUST H-12, Islamabad
              </p>
            </div>
          </div>
          <ContactUS fontSize="text-2xl" fontColor="text-white" marginTop="mt-[50px]" />
        </div>
      </div>
        ...
        <div className="border-r relative mr-24 border-gray-800 w-full p-10 flex items-center justify-center">
          ...
          <div>
            <ul className="flex items-center">
              <li className="text-lg Sansmedium leading-7 text-gray-400 ">Terms of Service</li>
              <li className="ml-10 text-lg Sansmedium leading-7 text-gray-400 ">Privacy Policy</li>
            </ul>
          </div>
        </div>
      </div>
